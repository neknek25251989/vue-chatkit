<template>
    <div class="message-form ld-over">
        ...
        <b-form @submit.prevent="onSubmit" class="ld-over" v-bind:class="{running: sending}">
            ...
            <b-alert varuant="danger" :show="hasError">{{ error }}</b-alert>
            <b-form-group>
                <b-form-input id="message-input" type="text" v-model="message" placeholder="Enter Message" autocomplete="off" required></b-form-input>
            </b-form-group>
            <div class="clearfix">
